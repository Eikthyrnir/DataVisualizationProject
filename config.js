...
const CSV_PATH = 'raw_data/tura_1/wyniki_gl_na_kandydatow_po_gminach_utf8.csv';
const GEO_WOJ_PATH = 'contours_data/pol_admbnda_adm1_gov_v02_20220414.json';
const GEO_POW_PATH = 'contours_data/WGS84/powiaty.json';
const GEO_GMINA_PATH = 'contours_data/WGS84/gminy.json';
